	...
	<menu>
                        ...
                        <table class="table_menu">	
                            <td class="td_menu"><a style="text-decoration:none; color:white; text-shadow: 8px 0px 8px black;" href="/~sdelaher/pages/historique_commande.php" onclick="window.open(this.href, '', 
                            ...
                            <td class="td_menu"><a style="text-decoration:none; color:white; text-shadow: 8px 0px 8px black;" href="/~sdelaher/pages/deco.php">Déconnexion</a></td>
